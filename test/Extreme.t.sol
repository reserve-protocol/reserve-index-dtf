...
import { Folio, MAX_AUCTION_LENGTH, MAX_TRADE_DELAY, MIN_FOLIO_FEE_HALF_LIFE, MAX_TTL, MAX_PRICE_RANGE } from "contracts/Folio.sol";
...
contract ExtremeTest is BaseExtremeTest {
    ...
    function run_mint_redeem_scenario(MintRedeemTestParams memory p) public {
        ...
        uint256 folioFee = MIN_FOLIO_FEE_HALF_LIFE;
