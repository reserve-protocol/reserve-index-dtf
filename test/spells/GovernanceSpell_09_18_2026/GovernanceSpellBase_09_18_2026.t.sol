...
contract GovernanceSpellBase_09_18_2026_Test is GenericGovernanceSpell_09_18_2026_Test {
    constructor() {
        ...
        // BGCI
        {
            ...
            CONFIGS.push(
                Config({
                    ...
                    tradingTimelock: 0x3A1f432aD1F1a2012b2CdB2945Aa0DE7C5a26abA,
                    guardians: guardians
                })
            );
        }
        ...
        // CLANKER
        {
            ...
            CONFIGS.push(
                Config({
                    ...
                    tradingTimelock: 0x8F288a46681AF76512353a296edD389945faEeDA,
                    guardians: guardians
                })
            );
        }
