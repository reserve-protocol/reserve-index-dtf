 ...
 * easy upgrade and replacement of these governors.
 *
 * See dev comments below for details on how to use each function.
 */
contract GovernanceUpgrader is Versioned {
    ...
    function upgradeFolioGovernance(
        ...
        // TODO decide if we want to upgrade the folio too
    }
    ...
    function _deployReplacementGovernance(
        ...
        require(quorumThreshold != 0 && quorumThreshold <= 1e17, "quorum threshold not in expected range");
