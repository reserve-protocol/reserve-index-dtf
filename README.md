...
TVL fees and mint self-fee handouts share `lastPoke`. A checkpoint within the first four minutes of a UTC day is interpreted as day-aligned. As a result, initialization or upgrade during that interval can account for up to four extra minutes of TVL fees; this avoids a separate initialization flag or handout timestamp. At other times, the initial handout window is treated as already consumed.
